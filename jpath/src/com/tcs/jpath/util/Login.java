...
public class Login {
    ...
    public void doLogin() throws JavascriptException{
        
        JConfig info = new JConfig();
        com.tcs.jpath.modal.Login login =   info.getLoginDetails();
        String branchContent   = login.getBranch();
        String institutionContent   = login.getInst();
        String userNameContent = login.getUserName();
        String passwordContent = login.getPassword();
...
//        String institutionContent= mod.getInstitutionContent();
        ...
        String brValue = "basebranch";
        String inValue= "institution";
        String userValue = "usruserid";
        String passValue = "usrpwd";
